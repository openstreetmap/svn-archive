...
!macro JOSM_MACRO_LANGUAGEFILE_END
  ...
  !insertmacro JOSM_MACRO_LANGSTRING_INSERT JOSM_SEC_OPENSTREETBUGS_PLUGIN 	${CUR_LANG}
  !insertmacro JOSM_MACRO_LANGSTRING_INSERT JOSM_SEC_REMOTECONTROL_PLUGIN 	${CUR_LANG}
  ...
  !insertmacro JOSM_MACRO_LANGSTRING_INSERT JOSM_SECDESC_OPENSTREETBUGS_PLUGIN  ${CUR_LANG}
  !insertmacro JOSM_MACRO_LANGSTRING_INSERT JOSM_SECDESC_REMOTECONTROL_PLUGIN   ${CUR_LANG}

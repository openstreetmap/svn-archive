package Geo::OSM::MapFeatures::Feature::Value::Date;
...
Geo::OSM::MapFeatures::Feature::Value::Date - Date value type
...
Please report any bugs or feature requests to C<bug-geo-osm-mapfeatures-feature-value-date at rt.cpan.org>, or through
...
1; # End of Geo::OSM::MapFeatures::Feature::Value::Date

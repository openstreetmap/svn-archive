package Geo::OSM::MapFeatures::Feature::Value::Userdef;
...
Geo::OSM::MapFeatures::Feature::Value::Userdef - User defined value type
...
User defined means the feature value can be anything the user wants.
...
Please report any bugs or feature requests to C<bug-geo-osm-mapfeatures-feature-value-userdef at rt.cpan.org>, or through
...
1; # End of Geo::OSM::MapFeatures::Feature::Value::Userdef

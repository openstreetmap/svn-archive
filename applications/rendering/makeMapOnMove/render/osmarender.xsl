 ...
 xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:variable name="bottomLeftLatitude">
		<xsl:choose>
			...
			<xsl:when test='$data/osm/bounds'>
				<xsl:value-of select='$data/osm/bounds/@returned_minlat'/>
			</xsl:when>
			<xsl:otherwise>
	...
	<xsl:variable name="bottomLeftLongitude">
		<xsl:choose>
			...
			<xsl:when test='$data/osm/bounds'>
				<xsl:value-of select='$data/osm/bounds/@returned_minlon'/>
			</xsl:when>
			<xsl:otherwise>
	...
	<xsl:variable name="topRightLatitude">
		<xsl:choose>
			...
			<xsl:when test='$data/osm/bounds'>
				<xsl:value-of select='$data/osm/bounds/@returned_maxlat'/>
			</xsl:when>
			<xsl:otherwise>
	...
	<xsl:variable name="topRightLongitude">
		<xsl:choose>
			...
			<xsl:when test='$data/osm/bounds'>
				<xsl:value-of select='$data/osm/bounds/@returned_maxlon'/>
			</xsl:when>
			<xsl:otherwise>

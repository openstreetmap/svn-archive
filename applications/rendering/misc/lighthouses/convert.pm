...
# *** DEPRECATED ***
#
# All functionality has been moved to smaller more manageable modules.
# Please use those, and don't update this file!
#----------------------------------------------------------------------------
# Convert the lighthouse data provided by Commissioners of Irish Lighthouses
# http://bbs.keyhole.com/ubb/showflat.php/Cat/0/Number/812193
# to OpenStreetMap format
#----------------------------------------------------------------------------

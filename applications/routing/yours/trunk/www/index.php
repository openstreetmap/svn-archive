                    ...
                    <div id="fragment-route">
                        <form id="route" name="route" action="#" onsubmit="return false;">
                            <ul class="route_via">
                                <li id="waypointFrom">
                                    <div>
                                        <input type="image" src="markers/route-start.png" alt="Start marker" title="Click to position start on the map" style="vertical-align:middle;" name="from" onclick="elementClick(this);" />
                                        <input type="text" name="from_text" onclick="elementClick(this);" onchange="elementChange(this);" value="e.g. Street, City" tabindex="1" onfocus="this.select()" />
                                ...
                                <li id="WaypointTo">
                                    <div>
                                        <input type="image" src="markers/route-stop.png" alt="Finish marker" title="Click to position finish on the map" style="vertical-align:middle;" name="to" onclick="elementClick(this);" />
                                        <input type="text" name="to_text" onclick="elementClick(this);" onchange="elementChange(this);" value="e.g. Street, City" tabindex="2" onfocus="this.select()" />

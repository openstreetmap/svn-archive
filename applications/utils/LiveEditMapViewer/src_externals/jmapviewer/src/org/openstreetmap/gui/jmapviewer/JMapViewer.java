...
public class JMapViewer extends JPanel implements TileLoaderListener {
    ...
    private List<MapViewChangeListener> mapChangeListenerList;
    private List<OverlayPainter> overlayPainterList;
    ...
    public void addChangeListener(MapViewChangeListener cl) {
    	mapChangeListenerList.add(cl);
    }
    
    public void addOverlayPainter(OverlayPainter op) {
    	overlayPainterList.add(op);
    }
    ...
    public void removeChangeListener(MapViewChangeListener cl) {
    	mapChangeListenerList.remove(cl);
    }
    
    public void removeOverlayPainter(OverlayPainter op) {
    	overlayPainterList.remove(op);
    }
    ...
    private void fireMapViewChanged() {
    	for (MapViewChangeListener cl : mapChangeListenerList) {
    		cl.mapViewChanged();
    	}
    }
}

...
#	system ("java -Xmx1256M -jar mkgmap.jar --description=Osm_Austria_v2 --map-features=resources/cycling_map_features_typfile.csv --levels=0:24,1:22,2:20,3:18,4:16,5:14,6:12,7:10,8:8 $tempdir/*");
	system ("java -Xmx1256M -jar mkgmap.jar --description=Osm_Austria_v2 --map-features=resources/cycling_map_features_typfile.csv --levels=0:24,1:22,2:20,3:17,4:14,5:12,6:9 *.osm.processed");

...
# constants
my $version = "6.3" ;
my $usage = "usage:  unmappedplaces.pl <osmfile> <htmlfile> <slippyfile>\n" ;
...
my $iconRed = "unmapped_red.png" ;
my $iconYellow = "unmapped_yellow.png" ;
...
foreach $placekey (keys %place_name) { 
		...
		print $slippy_file $place_name {$placekey}, "\t" ;
			...
			print $slippy_file "./", $iconYellow, "\t" ;
		}
		print $slippy_file "24,24", "\t" ;
		print $slippy_file "-12,-12", "\n" ;
        } 
} 

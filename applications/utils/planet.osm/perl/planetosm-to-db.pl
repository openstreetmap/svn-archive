...
INSERT INTO current_nodes (id,user_id,latitude,longitude,timestamp,tags,visible,tile) SELECT id,user_id,latitude,longitude,timestamp,tags,1,tile FROM nodes

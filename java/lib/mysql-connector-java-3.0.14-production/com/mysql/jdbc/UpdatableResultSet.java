...
public class UpdatableResultSet extends ResultSet {
                ...
                if (getCharConverter() != null) {
                    try {
                        this.thisRow[columnIndex - 1] = StringUtils.getBytes(x,
                                this.charConverter, this.charEncoding, this.connection.parserKnowsUnicode());
    ...
    protected synchronized void generateStatements() throws SQLException {
        ...
        if (fields[0].getOriginalTableName() != null) {
            ...
            this.tableOnlyName = fields[0].getOriginalTableName();
            ...
            this.tableOnlyName = fields[0].getTableName();
        ...
        updateSQL = "UPDATE " + this.qualifiedAndQuotedTableName + " " + fieldValues.toString()
            + " WHERE " + keyValues.toString();
        insertSQL = "INSERT INTO " + this.qualifiedAndQuotedTableName + " ("
            + columnNames.toString() + ") VALUES ("
            + insertPlaceHolders.toString() + ")";
        refreshSQL = "SELECT " + columnNames.toString() + " FROM " + qualifiedAndQuotedTableName
            + " WHERE " + keyValues.toString();
        deleteSQL = "DELETE FROM " + this.qualifiedAndQuotedTableName + " WHERE "
            + keyValues.toString();
    }

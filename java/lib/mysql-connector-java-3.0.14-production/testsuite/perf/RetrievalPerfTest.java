...
public class RetrievalPerfTest extends BaseTestCase {
    ...
    public static void main(String[] args) {
        junit.textui.TestRunner.run(RetrievalPerfTest.class);
    }
    ...
    public void setUp() throws Exception {
        ...
        stmt.executeUpdate(
            "CREATE TABLE retrievalPerfTestHeap (priKey INT NOT NULL PRIMARY KEY,"
            + "charField VARCHAR(80)) TYPE=HEAP");
        stmt.executeUpdate(
            "CREATE TABLE retrievalPerfTestMyIsam (priKey INT NOT NULL PRIMARY KEY,"
        ...
        for (int i = 0; i < NUM_ROWS; i++) {
            ...
            stmt.executeUpdate(
                "INSERT INTO retrievalPerfTestMyIsam (priKey, charField) VALUES ("
                + i
                + ",'abcdefghijklmnopqrstuvqxyzABCDEFGHIJKLMNOPQRSTUVWXYZ')");
        }
    }

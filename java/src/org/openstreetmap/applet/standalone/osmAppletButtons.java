...
public class osmAppletButtons extends JPanel implements ActionListener
{
  ...
  public osmAppletButtons(osmDisplay osmdisp, osmAppletLineDrawListener oLDL)
  {
    ...
    ButtonGroup gpxButtons = new ButtonGroup();
	JToggleButton segments=new JToggleButton("Select segs");
	JToggleButton del=new JToggleButton("Delete trkpts");
	JToggleButton wpts=new JToggleButton("Edit wpts");
	JButton open=new JButton("Open");
	JButton save=new JButton("Save");
	segments.addActionListener(this);
	del.addActionListener(this);
	wpts.addActionListener(this);
	open.addActionListener(this);
	save.addActionListener(this);
	gpxButtons.add(segments);
	gpxButtons.add(del);
	gpxButtons.add(wpts);

	segType=new JComboBox(LookAndFeel.getTrackTypes());
	segType.addActionListener(this);
    JPanel gpxTools = new JPanel();
	gpxTools.add(segments);
	gpxTools.add(del);
	gpxTools.add(wpts);
	gpxTools.add(open);
	gpxTools.add(save);
	gpxTools.add(new JLabel("Segment type:"));
	gpxTools.add(segType);
	...
	tabbedPane.add("GPX", gpxTools);// NW	
  ...
  public void actionPerformed(ActionEvent e)
  {
   ...
   // NW
   System.out.println(e.getActionCommand());
   if(e.getActionCommand().equals("Select segs"))
	   od.setGPXMode(GPXLayer.SEGMENTISE);	   
   else if(e.getActionCommand().equals("Delete trkpts"))
	   od.setGPXMode(GPXLayer.DELETE_POINTS);	   
   else if(e.getActionCommand().equals("Edit wpts"))
	   od.setGPXMode(GPXLayer.EDIT_WAYPOINTS);	   
   ...
   if(e.getSource()==segType)
   {
		od.setSegType((String)segType.getSelectedItem());
   }
  }

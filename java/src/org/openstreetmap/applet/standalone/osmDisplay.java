...
//    selectLayer.setProperties(shapeLayerProps);
  ...
  // NW
  public void setGPXMode(int mode)
  {
	gpxLayer.setMode(mode);
  }

  public void openGPX()
  {
	JFileChooser chooser=new JFileChooser(".");
	int returnValue=chooser.showOpenDialog(container);
	if(returnValue==JFileChooser.APPROVE_OPTION)
	{
		String name=chooser.getSelectedFile().getName();
		System.out.println("returned from chooser: " + name);
		try
		{
			gpxLayer.loadGPX(name);
		}
		catch(Exception e)
		{
  ...
  public void saveGPX()
  {
	...
	JFileChooser chooser=new JFileChooser(".");
	int returnValue=chooser.showSaveDialog(container);
	if(returnValue==JFileChooser.APPROVE_OPTION)
	{
		String name=chooser.getSelectedFile().getName();
		try
		{
			gpxLayer.saveGPX(name);
		}
		catch(Exception e)
		{
			System.out.println("Error: " + e);

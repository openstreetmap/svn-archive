...
public abstract class BasePerfTest extends BaseTestCase {
    ...
    /**
     * Sub-classes should override this to perform the operation to be
     * measured.
     *
    ...
    protected double getStandardDeviationP() {
        ...
        return Math.sqrt(((this.numIterations * this.squareSumValue)
            - (this.sumValue * this.sumValue)) / (this.numIterations * this.numIterations));
    }

    /**
     * Adds one test result to the statistics.
     *
     * @param value a single result representing the value being measured in
     *        the test.
     */
     ...
     *
     * @param numIterations the number of iterations to perform ( &lt; 30)
     *
     * @throws Exception if an error occurs.
     */

...
# This uses mapserver bindings to plot gpx points. only the fucking projection is a nightmare to get correct
# and mapserver is a piece of shit with no documentation and crap error messages

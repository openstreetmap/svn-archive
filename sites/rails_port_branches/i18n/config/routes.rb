ActionController::Routing::Routes.draw do |map|
  ...
  map.connect '/user/:display_name/diary/:language', :controller => 'diary_entry', :action => 'list'
  map.connect '/user/:display_name/diary/:language/rss', :controller => 'diary_entry', :action => 'rss'
  ...
  map.connect '/translate/:locale/:id/rss', :controller => 'translate', :action => 'rss', :id => /pending|complete/
  map.connect '/translate/:locale/:id', :controller => 'translate', :action => 'view', :id => /\d+/
  map.connect '/translate/:locale/:id/update', :controller => 'translate', :action => 'update'

...
#  Lat+Long -> easting/northing (OS Only)
#  easting/northing -> Lat+Long (OS Only)
...
##############################################################
#           OS Specific Helpers for Generic Methods          #
##############################################################
